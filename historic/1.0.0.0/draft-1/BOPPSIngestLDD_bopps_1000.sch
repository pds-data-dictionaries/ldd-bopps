<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:bopps  Version:1.0.0.0 - Tue Apr 14 12:22:09 EDT 2015 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="bopps:observation_parameters/bopps:product_type">
      <sch:assert test=". = ('BIAS_SUBTRACTED', 'CALIBRATED', 'COADDED', 'RAW', 'SHIFTED')">
        The attribute bopps:product_type must be equal to one of the following values 'BIAS_SUBTRACTED', 'CALIBRATED', 'COADDED', 'RAW', 'SHIFTED'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
