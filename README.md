...
# Balloon Observation Platform for Planetary Science (bopps:) Mission Dictionary

The BOPPS dictionary provides classes and attributes for working with the 
BOPPS mission archive data. The BOPPS mission flew in 2014.

### Steward
Original author: Ray Espiritu, BOPPS mission

Archive curator: Anne Raugh (@acraugh), Small Bodies Node (SBN)
...
* **[docs](docs)/** - This directory is for holding the documentation source tree.
* **[historic](historic)/** - This directory contains the schema files produced for the
draft and first archival deliveries of the BOPPS mission data. These are no longer
supported by modern Ingest_LDD structure or LDD tooling. They are provided for
historical reference to support the original v1 of the archive. 
